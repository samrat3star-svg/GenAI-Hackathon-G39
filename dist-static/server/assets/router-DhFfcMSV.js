...
const appCss = "./assets/styles-CbDQsPwj.css";
const ARCHETYPES = {
  "void-gazer": {
    id: "void-gazer",
    name: "The Void-Gazer",
    tagline: "Drawn to the deep end.",
    description: "You watch films like you read poetry — slowly, with the lights off. Stillness, weight, the long stare.",
  ...
  "pulse-chaser": {
    ...
    description: "You want movement, payoff, a film that knows where it's going. Cinema as a heartbeat.",
  ...
  empath: {
    ...
    description: "You watch for the people, the small moments, the quiet ache. Stories that stay with you.",
  ...
  architect: {
    ...
    description: "You love the machinery — the twist, the structure, the puzzle that locks into place on the rewatch.",
...
const initial = { archetype: null, watchlist: [] };
function loadState() {
...
function CineVaultProvider({ children }) {
  const [archetype, setArchetypeState] = reactExports.useState(null);
  ...
  const setArchetype = reactExports.useCallback((id) => {
    setArchetypeState(id);
  }, []);
  const addMovie = reactExports.useCallback((movieId) => {
    setWatchlist((prev) => {
      if (prev.some((w) => w.movieId === movieId)) return prev;
      return [{ movieId, addedAt: Date.now(), watched: false }, ...prev];
    });
  }, []);
  const removeMovie = reactExports.useCallback((movieId) => {
    setWatchlist((prev) => prev.filter((w) => w.movieId !== movieId));
  }, []);
  const markWatched = reactExports.useCallback((movieId, verdict) => {
    setWatchlist(
      (prev) => prev.map(
        (w) => w.movieId === movieId ? { ...w, watched: true, verdict, watchedAt: Date.now() } : w
      )
    );
  }, []);
  const hasMovie = reactExports.useCallback(
    (id) => watchlist.some((w) => w.movieId === id),
    [watchlist]
  );
  ...
  const seedDemo = reactExports.useCallback((movieIds) => {
    setWatchlist((prev) => {
      const existing = new Set(prev.map((w) => w.movieId));
      const additions = movieIds.filter((id) => !existing.has(id)).map((id, i) => ({ movieId: id, addedAt: Date.now() - i * 1e3, watched: false }));
      return [...additions, ...prev];
    });
  }, []);
  const [detailMovieId, setDetailMovieId] = reactExports.useState(null);
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-dvh items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 font-display text-xl text-foreground", children: "This reel doesn't exist." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Reel checked the archive — nothing here." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
        className: "inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90",
        children: "Back to CineVault"
      }
    ) })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-dvh items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl text-foreground", children: "This page didn't load." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-full border border-border px-5 py-2.5 text-sm", children: "Go home" })
    ] })
  ] }) });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CineVaultProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { position: "bottom-center" })
  ] }) });
}
const $$splitComponentImporter$5 = () => import("./watchlist-C3MzsytH.js");
const Route$5 = createFileRoute("/watchlist")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./search-D-kwyzgk.js");
const Route$4 = createFileRoute("/search")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./profile-CsliTXRB.js");
const Route$3 = createFileRoute("/profile")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./onboarding-BQ9lx_WR.js");
const Route$2 = createFileRoute("/onboarding")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./browse-B2ypgENO.js");
const Route$1 = createFileRoute("/browse")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CNufIsrq.js");
const Route2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const WatchlistRoute = Route$5.update({
  id: "/watchlist",
  path: "/watchlist",
...
const OnboardingRoute = Route$2.update({
  id: "/onboarding",
  path: "/onboarding",
  getParentRoute: () => Route$6
});
const BrowseRoute = Route$1.update({
  id: "/browse",
  path: "/browse",
  getParentRoute: () => Route$6
});
